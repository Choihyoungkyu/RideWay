        ...
        retrofitAPI.insertCommunity(
            ...
            override fun onResponse(call: Call<Void>, response: Response<Void>) {
                if(response.isSuccessful){
                    Toast.makeText(this@CommunityWriteActivity, "등록 성공", Toast.LENGTH_SHORT).show()
                    finish()
                }else{
                    Toast.makeText(this@CommunityWriteActivity,"등록 실패",Toast.LENGTH_SHORT).show()
                }
            }
            override fun onFailure(call: Call<Void>, t: Throwable) {
                Toast.makeText(this@CommunityWriteActivity,"네트워크 오류",Toast.LENGTH_SHORT).show()
            }
        })
    }
        ...
        retrofitAPI.getAllSi().enqueue(object : Callback<SiData> {
            override fun onResponse(call: Call<SiData>, response: Response<SiData>) {
                if(response.isSuccessful){
                    ...
                    binding.spSi.adapter = ArrayAdapter<String>(this@CommunityWriteActivity, R.layout.simple_list_item_1, list)
                    ...
                    Toast.makeText(this@CommunityWriteActivity,"시 목록을 가져오지 못했습니다.", Toast.LENGTH_SHORT).show()
                }
            }
        ...
        retrofitAPI.getSelectedGun(si_code).enqueue(object : Callback<GunData> {
            override fun onResponse(call: Call<GunData>, response: Response<GunData>) {
                if(response.isSuccessful){
                    ...
                    binding.spGun.adapter = ArrayAdapter<String>(this@CommunityWriteActivity, R.layout.simple_list_item_1, list)
                    ...
                    Toast.makeText(this@CommunityWriteActivity,"군 목록을 가져오지 못했습니다.", Toast.LENGTH_SHORT).show()
                }
            }
        ...
        retrofitAPI.getSelectedDong(si_code,gun_code).enqueue(object : Callback<DongData> {
            override fun onResponse(call: Call<DongData>, response: Response<DongData>) {
                if(response.isSuccessful){
                    ...
                    binding.spDong.adapter = ArrayAdapter<String>(this@CommunityWriteActivity, R.layout.simple_list_item_1, list)
